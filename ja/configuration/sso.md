...
* `Groups-Attribute` [デフォルト: "http://schemas.microsoft.com/ws/2008/06/identity/claims/groups"]: ユーザが属するグループのリストを含む SAML 属性を定義します。通常、グループ・リストを送信するために、SSO プロバイダを明示的に構成する必要があります。
